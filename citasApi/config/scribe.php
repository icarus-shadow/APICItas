...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'Puedes obtener tu token visitando tu panel de control y haciendo clic en <b>Generar token de API</b>.',
    ],
    ...
    // Note: does not work for `external` docs types
    'last_updated' => 'Última actualización: {date:j \d\e F \d\e Y}',
